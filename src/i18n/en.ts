...
export const en = {
  ...
  trust: {
    ...
    reviews: "Live design preview before you order",
    delivery: "Delivery to all 7 Emirates",
    secure: "Transparent VAT-inclusive pricing",
  ...
  customize: {
    ...
    subtitle: "Design your gift and see it rendered live, then send your order on WhatsApp.",
    steps: {
      upload: "Upload",
      preview: "Preview",
      message: "Message",
    ...
    pay: {
      ...
      sub: "Send your order via WhatsApp — our team confirms the design, delivery and payment options with you in the chat.",
      sendWhatsApp: "Send order via WhatsApp",
      note: "You'll attach your photo in the WhatsApp chat; nothing is charged until you confirm with our team.",
      successTitle: "Your order request is ready!",
      successSub: "We've opened WhatsApp with order request {ref}. Send the message and attach your photo — our studio will confirm the design proof, delivery and payment with you there.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "How do I pay?", a: "Orders are arranged through WhatsApp: our team confirms your total and shares the available payment options with you in the chat before anything is charged." },
  ...
  contact: {
    ...
    message: "Message",
    send: "Send message",
    sent: "We opened WhatsApp with your message — send it there and we'll reply shortly.",
  ...
  legal: {
    ...
    terms: {
      ...
      sections: [
        ...
        { h: "Payment", b: "Orders are placed via WhatsApp. Our team confirms the total and the available payment options with you in the chat; orders are dispatched after payment is confirmed." },
